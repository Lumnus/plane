...
# Generic OIDC (Lumnus addition) — endpoints resolved from OIDC_ISSUER discovery, or set the explicit
# OIDC_*_URL keys. OIDC_CLIENT_SECRET is encrypted at rest like other client secrets.
